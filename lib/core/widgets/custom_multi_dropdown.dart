...
class CustomStringMultiDropdownSearch extends StatefulWidget {
  const CustomStringMultiDropdownSearch({
    super.key,
    required this.items,
    this.label,
    this.errorText,
  ...
  final String? label;
  final String? errorText;
  final List<DropStringItem> selectedItems;
  final void Function(List<DropStringItem>)? onChanged;
  ...
  @override
  State<CustomStringMultiDropdownSearch> createState() =>
      _CustomStringMultiDropdownSearch();
}
...
class _DropStringDownView extends StatefulWidget {
  const _DropStringDownView({
    required this.selectedItems,
    this.onChanged,
    required this.items,
  });
  ...
  final List<DropStringItem> items;
  @override
  State<_DropStringDownView> createState() => __DropStringDownViewState();
}

class __DropStringDownViewState extends State<_DropStringDownView> {
  final TextEditingController _searchController = TextEditingController();
