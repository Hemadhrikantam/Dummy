...
class _DaySelectorState extends State<DaySelector> {
  ...
  final BorderRadius _borderRadius = const BorderRadius.all(Radius.circular(15.0));
  ...
  Widget _defaultDayBuilder(DateTime day, bool isSelected) {
    ...
    final textColor = isSelected ? _selectedTextStyle.color : _unselectedTextStyle.color;
            ...
            .map((day) {
              ...
              return Padding(
                ...
                child: GestureDetector(
                  ...
                  child: _defaultDayBuilder(day, isSelected), // Using the default builder
                ),
              );
            })
            .toList(),
