...
mixin _$AuthState {
 ...
 NotEmpty get email; Password get password; NotEmpty get name; Password get confirmPassword; CurrentUser? get user; Status get loginStatus; bool get loginValidation; Status get signupStatus; bool get signupValidation;
...
@override
int get hashCode => Object.hash(runtimeType,email,password,name,confirmPassword,user,loginStatus,loginValidation,signupStatus,signupValidation);

@override
String toString() {
  return 'AuthState(email: $email, password: $password, name: $name, confirmPassword: $confirmPassword, user: $user, loginStatus: $loginStatus, loginValidation: $loginValidation, signupStatus: $signupStatus, signupValidation: $signupValidation)';
}
...
@useResult
$Res call({
 NotEmpty email, Password password, NotEmpty name, Password confirmPassword, CurrentUser? user, Status loginStatus, bool loginValidation, Status signupStatus, bool signupValidation
});
...
/// Create a copy of AuthState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? email = null,Object? password = null,Object? name = null,Object? confirmPassword = null,Object? user = freezed,Object? loginStatus = null,Object? loginValidation = null,Object? signupStatus = null,Object? signupValidation = null,}) {
...
class _AuthState implements AuthState {
  const _AuthState({this.email = const NotEmpty.pure(), this.password = const Password.pure(), this.name = const NotEmpty.pure(), this.confirmPassword = const Password.pure(), this.user = null, this.loginStatus = Status.init, this.loginValidation = false, this.signupStatus = Status.init, this.signupValidation = false});
...
/// Create a copy of AuthState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? email = null,Object? password = null,Object? name = null,Object? confirmPassword = null,Object? user = freezed,Object? loginStatus = null,Object? loginValidation = null,Object? signupStatus = null,Object? signupValidation = null,}) {
