                  ...
                  child: AnimatedColumn(
                    ...
                    children: [
                      OverviewCard(
                        ...
                        title: AppText.meals,
                        subtitle: state.overview?.meals.toString() ?? '',
                        onTap: () {},
                      ),
                      Styles.gap10,
                      OverviewCard(
                        ...
                        title: AppText.walks,
                        subtitle: state.overview?.walks.toString() ?? '',
                        onTap: () {},
                      ),
                      Styles.gap10,
                      OverviewCard(
                        ...
                        subtitle: state.overview?.grooming.toString() ?? '',
                        onTap: () {},
                      ),
                      Styles.gap10,
                      OverviewCard(
                        ...
                        subtitle: state.overview?.deworming.toString() ?? '',
                        onTap: () {},
                      ),
                      Styles.gap10,
                      OverviewCard(
                        ...
                        subtitle: state.overview?.expenses.toString() ?? '',
                        onTap: () {},
                      ),
                    ],
                  ),
