...
class PetMedicationModel extends PetMedication {
  ...
  factory PetMedicationModel.fromJson(Map<String, dynamic> json) {
    ...
    return PetMedicationModel(
      ...
      dosageValue: (json['dosage_value'] ?? json['dosage'] ?? '') as String,
      dosageTypeId: json['dosage_type_id'] as String?,
      dosageTypeName: json['dosage_type_name'] as String?,
  ...
  Map<String, dynamic> toJson() {
    ...
    return {
      ...
      if (dosageTypeId != null) 'dosage_type_id': dosageTypeId,
      if (dosageTypeName != null) 'dosage_type_name': dosageTypeName,
