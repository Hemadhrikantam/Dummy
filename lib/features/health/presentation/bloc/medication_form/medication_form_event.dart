...
class MedicationFormEvent with _$MedicationFormEvent {
  ...
  const factory MedicationFormEvent.morningTimeHour(DropItem value) =
      _MorningTimeHour;
  const factory MedicationFormEvent.morningTimeMin(DropItem value) =
      _MorningTimeMin;

  const factory MedicationFormEvent.afternoonTimeHour(DropItem value) =
      _AfternoonTimeHour;
  const factory MedicationFormEvent.afternoonTimeMin(DropItem value) =
      _AfternoonTimeMin;

  const factory MedicationFormEvent.nightTimeHour(DropItem value) =
      _NightTimeHour;
  const factory MedicationFormEvent.nightTimeMin(DropItem value) =
      _NightTimeMin;

  const factory MedicationFormEvent.morningTimeEnable(bool value) =
      _MorningTimeEnable;
  const factory MedicationFormEvent.nightTimeEnable(bool value) =
      _NightTimeEnable;
  const factory MedicationFormEvent.afternoonTimeEnable(bool value) =
      _AfternoonTimeEnable;
