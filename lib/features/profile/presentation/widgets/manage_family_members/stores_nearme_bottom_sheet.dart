        ...
        return ListView(
          ...
          children: [
            ...
            CustomCard(
              ...
              child: Row(
                children: [
                  TextValueWidget(text: 'Stores Name   1.5km', value: 'Jeeva Pet Store'),
                  Styles.spacer,
            ...
            Styles.gap10,
             CustomCard(
              ...
              child: Row(
                children: [
                  TextValueWidget(text: 'Stores Name   1.5km', value: 'Jeeva Pet Stores'),
                  Styles.spacer,
                  AppAssestsImage(path: ImageResources.map,width: 30,height: 30,boxFit: BoxFit.contain,),
            ...
            Styles.gap10,
             CustomCard(
              ...
              child: Row(
                children: [
                  TextValueWidget(text: 'Stores Name   1.5km', value: 'Stores Pet Clinic'),
                  Styles.spacer,
                  AppAssestsImage(path: ImageResources.map,width: 30,height: 30,boxFit: BoxFit.contain,),
